...
Next I assigned two different network adapters to each machine. One was an interanl network the other was a NAT. 
...
I first assigned the IP address for the windows machine. I opened up the properties of the internal networks ethernet.
...
And Assigned it the address 192.168.20.11.
&nbsp;
...
Finally, I went back to the windows machine and performed a ping test to see if the machines could communicate.
<img width="472" height="210" alt="WinKalipingtest" src="https://github.com/user-attachments/assets/317ddfdf-d269-49e3-90d8-0e335608634e" />
